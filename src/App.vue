...
.login-wrap {
  ...
  background: url(https://raw.githubusercontent.com/khadkamhn/day-01-login-form/master/img/bg.jpg)
    no-repeat center;
  box-shadow: 0 20px 15px 0 rgba(0, 0, 0, 0.24),
...
.logo {
  background: url(https://tivit.com/wp-content/themes/tivit_theme/library/img/logo.png)
    no-repeat center;
  height: 80px;
}
